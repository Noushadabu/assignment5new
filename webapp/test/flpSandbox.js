		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#abuassignment5new-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"abuassignment5new-display": {
								"semanticObject": "abuassignment5new",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=abu.assignment5new",
									"url": sap.ui.require.toUrl("abu/assignment5new")
								}
							}
						}
					}
